...
if cups_of_flour >= 2 && has_sauce == true
  ...
  puts "I need to get sauce before I can make pizza."
elsif cups_of_flour < 2 && has_sauce == true
  puts "I need more flour before I can make pizza."
elsif cups_of_flour == 0 && has_sauce == false
  puts "I have nothing. What am I even doing here?"
else
  puts "I need more flour and sauce before I can make pizza."
end